    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-microphone me-2"></i>Thêm Voice mới</h2>
                    ...
                    <form action="{{ route('admin.voices.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('voice_id') is-invalid @enderror" 
                                           id="voice_id" name="voice_id" value="{{ old('voice_id') }}" required>
                                    @error('voice_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="premade" {{ old('category') == 'premade' ? 'selected' : '' }}>Premade</option>
                                        <option value="custom" {{ old('category') == 'custom' ? 'selected' : '' }}>Custom</option>
                                        <option value="cloned" {{ old('category') == 'cloned' ? 'selected' : '' }}>Cloned</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('age') is-invalid @enderror" 
                                        ...
                                        <option value="young" {{ old('age') == 'young' ? 'selected' : '' }}>Young</option>
                                        <option value="middle_aged" {{ old('age') == 'middle_aged' ? 'selected' : '' }}>Middle Aged</option>
                                        <option value="old" {{ old('age') == 'old' ? 'selected' : '' }}>Old</option>
                                    </select>
                                    @error('age')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('platforms') is-invalid @enderror" 
                                           id="platforms" name="platforms" value="{{ old('platforms', 'elevenlab') }}" readonly>
                                    @error('platforms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter voice description...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('fine_data') is-invalid @enderror" 
                                      ...
                                      placeholder='Enter JSON data... e.g., {"key": "value"}'>{{ old('fine_data') }}</textarea>
                            @error('fine_data')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Voice
                            </button>
                        </div>
                    </form>
                </div>
