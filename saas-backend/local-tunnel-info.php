 ...
 * 
 * This script provides all the URLs you need to test your Laravel backend
 * with ComfyUI or any external service
 */

$localPort = 8001;
$localIP = '192.168.0.101';
$localhost = "localhost:$localPort";
$localNetwork = "http://$localIP:$localPort";
...
echo "   Local Path:    " . public_path('uploads/runninghub-inputs/') . "\n";
...
echo "   IP: $localIP\n";
echo "   Upload dir exists: " . (is_dir(public_path('uploads/runninghub-inputs/')) ? '✅ YES' : '❌ NO') . "\n\n";
