...
import { createMyImageProvider } from '../../providers/MyImageProvider';
  ...
  const allProviders = {
    ...
    text2image: {
      ...
      providers: [
        ...
        {
          name: 'Custom AI Generator',
          label: 'Custom',
          selected: false,
          provider: (middleware) =>
            createMyImageProvider({
              apiKey: process.env.REACT_APP_CUSTOM_API_KEY || 'demo-key',
